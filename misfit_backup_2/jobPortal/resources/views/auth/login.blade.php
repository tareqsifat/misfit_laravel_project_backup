...
<div class="container">
    <div class="container-fluid">
        @if(session()->has('error'))
            <p class="p-1 mb-3 bg-danger text-white text-center" style="font-size: 20px">{{ session()->get('error')}}</p>
        @endif
    </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-dark
                                @if(!session()->has('role'))
                                    active
                                @endif" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                    ...
                    <div class="tab-pane fade
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('company.login') }}">
                                @csrf
                                <div class="row mb-3">
                                    <label for="email" class="col-md-4 col-form-label text-md-end">Company {{ __('Email Address') }}</label>
