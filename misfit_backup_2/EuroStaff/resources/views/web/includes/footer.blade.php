                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="footer-widget">
                        <div class="footer-widget-about">
                            <img src="{{asset('assets/web')}}/images/logo/eurostaff-logo.png" alt="">
    ...
    <div class="footer-bottom-section section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <p class="footer-copyright text-center">All rights Reserved © Eurostaffs Development Team 2023</p>
                </div>
