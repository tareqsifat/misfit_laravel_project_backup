            ...
            <div class="job-list-wrap">
                ...
                <a href="job-single.html" class="job-list row">
                    <div class="company-logo col-auto">
                        <img src="{{asset('assets/web')}}/images/companies/company-1.png" alt="Company Logo">
                    </div>
                ...
                <a href="job-single.html" class="job-list row">
                    <div class="company-logo col-auto">
                        <img src="{{asset('assets/web')}}/images/companies/company-2.png" alt="Company Logo">
                    </div>
                    <div class="salary-type col-auto order-sm-3">
                ...
                <a href="job-single.html" class="job-list row">
                    <div class="company-logo col-auto">
                        <img src="{{asset('assets/web')}}/images/companies/company-3.png" alt="Company Logo">
                    </div>
                    <div class="salary-type col-auto order-sm-3">
                        <span class="salary-range">$5000 - $8000</span>
                ...
                <a href="job-single.html" class="job-list row">
                    <div class="company-logo col-auto">
                        <img src="{{asset('assets/web')}}/images/companies/company-4.png" alt="Company Logo">
                    </div>
                    <div class="salary-type col-auto order-sm-3">
                        <span class="salary-range">$7000 - $13000</span>
                        <span class="badge bg-success">Full Time</span>
                ...
                <a href="job-single.html" class="job-list row">
                    <div class="company-logo col-auto">
                        <img src="{{asset('assets/web')}}/images/companies/company-5.png" alt="Company Logo">
                    </div>
                    <div class="salary-type col-auto order-sm-3">
                        <span class="salary-range">$5000 - $8000</span>
                        <span class="badge bg-success">Full Time</span>
    ...
    <div class="section section-padding">
        <div class="container">
            ...
            <div class="blog-slider slick-space">
                ...
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{asset('assets/web')}}/images/blog/blog-1.jpg" alt=""></a>
                    </div>
                    <div class="content">
                ...
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{asset('assets/web')}}/images/blog/blog-2.jpg" alt=""></a>
                    </div>
                    <div class="content">
                ...
                <div class="blog">
                    <div class="media">
                        <a href="blog-single.html"><img src="{{asset('assets/web')}}/images/blog/blog-3.jpg" alt=""></a>
                    </div>
                    <div class="content">
