        ...
        <div class="row">
            <div class="col-xl-9 col-lg-9 col-md-12 col-12">
                ...
                <div class="product box-shadow mtb-50 bg-fff">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1272px;"><div class="owl-item active" style="width: 211px; margin-right: 1px;"><div class="product-wrapper bl">
                        ...
                        </div></div><div class="owl-item active" style="width: 211px; margin-right: 1px;"><div class="product-wrapper bl">
                            <div class="product-img">
                                <a href="#">
                        ...
                        </div></div><div class="owl-item" style="width: 211px; margin-right: 1px;"><div class="product-wrapper bl">
                            <div class="product-img">
                                <a href="#">
                                    <img src="{{ asset('contents/website') }}/img/product/1.jpg" alt="" class="primary">
                                    <img src="{{ asset('contents/website') }}/img/product/2.jpg" alt="" class="secondary">
