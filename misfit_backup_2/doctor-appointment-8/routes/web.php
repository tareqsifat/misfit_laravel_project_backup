...
// routes/web.php
Route::group([
    'middleware'=>['auth', 'inactive-doctor'],
], function (){
...
Route::get('/dashboard', [PublicController::class, 'dashboard'])->middleware(['auth','inactive-doctor'])->name('dashboard.index');
...
Route::prefix('/appointment')->middleware(['auth','inactive-doctor'])->group(function () {
...
Route::group([
    'prefix' => 'pending_doctor',
    'middleware' => ['auth', 'admin'],
    ], function (){
    Route::get('/list', [\App\Http\Controllers\PendingDoctorController::class, 'index'])->name('pending-doctor-list');
    Route::post('/approve-doctor/{id}', [\App\Http\Controllers\PendingDoctorController::class, 'approveDoctor'])->name('approve-doctor');
});
Route::prefix('/profile')->middleware('auth')->group(function () {
    Route::get('/inactive-doctor', [ProfileController::class,'inactive_doctor'])->name('profile.inactive_doctor');
    Route::get('/profile/complete-profile', [ProfileController::class, 'incomplete'])->name('profile.incomplete');
    Route::post('/store', [ProfileController::class, 'store'])->name('profile.store');
});

Route::prefix('/profile')->middleware(['auth','inactive-doctor','profile.check'])->group(function () {
...
// for patient
Route::get('/chat-with-doctor/{doctor_id}', [App\Http\Controllers\ChatController::class, 'index'])->name('chat_with_doctor');
...
Route::get('/without-reload-chat-with-doctor/{doctor_id}', [App\Http\Controllers\ChatController::class, 'withoutReloadChatWithDoctor'])->name('withoutReloadChatWithDoctor');
