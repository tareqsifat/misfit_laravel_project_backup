                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 ">
                        <table v-if="this[`get_${store_prefix}`]" class="table table-bordered details_table">
                            <tr>
                                <td v-if="this[`get_${store_prefix}`].image" colspan="2" class="text-center">
                            ...
                            <tr>
                                <td>Highlighted Title</td>
                                <td>{{ this[`get_${store_prefix}`].title_highlight }}</td>
                            </tr>
                            <tr>
                                <td>Description</td>
                                <td>{{ this[`get_${store_prefix}`].paragraph }}</td>
                            </tr>
                            <tr>
                                <td>created at </td>
                                <td>
