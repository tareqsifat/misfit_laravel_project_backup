                    ...
                    <div class="col-lg-7 ">
                        <table v-if="this[`get_${store_prefix}`]" class="table table-bordered details_table">
                            ...
                            <tr>
                                <td>Visibility:</td>
                                <td>
                                    <span v-if="this[`get_${store_prefix}`].is_visible" class="badge rounded-pill bg-success">Visible</span>
                                    <span v-else class="badge rounded-pill bg-danger">Not Visible</span>
                                </td>
                            </tr>
                            <tr>
                                <td>Created at:</td>
