        ...
        <div class="card list_card">
            ...
            <div class="card-body pb-5" v-if="this[`get_${store_prefix}`]" id="print_section">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="row mb-4">
                            <div class="col-sm-6 col-6 col-lg-6 col-md-6">
                        ...
                        <div class="col-md-4 mx-auto">
                            <form class="status_change_form" action="javascript:void(0)" @submit.prevent="call_store(`set_${store_prefix}_status_update`, null)">
                                <div class="mb-2">
                                    ...
                                    <select id="order_status_change" v-model="this[`get_${store_prefix}`].status" class="form-select" name="status">
                                ...
                                <div class="mb-2">
                                    <label for="order_status_change" class="form-label">Change Payment Status</label>

                                    <select id="order_status_change" v-model="this[`get_${store_prefix}`].payment_status" class="form-select" name="payment_status">
                                        <option value="pending">Pending</option>
