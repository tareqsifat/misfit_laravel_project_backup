                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Name</td>
                            <td>:</td>
                            <td class="text-capitalize">{{ this[`get_${store_prefix}`].title }}</td>
                        </tr>
                        <tr>
                            <td>Description</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><img :src="`/${this[`get_${store_prefix}`].account_no}`" style="width: 40px;" alt=""></td>
                        </tr>
                        <tr>
                            <td>Account mobile no</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].account_mobile_no }}</td>
                        </tr>
                        <tr>
                            <td>Account email</td>
                            <td>:</td>
                            <td>{{ this[`get_${store_prefix}`].account_email }}</td>
                        </tr>
                        <tr>
                            <td>Created at</td>
                            <td>:</td>
