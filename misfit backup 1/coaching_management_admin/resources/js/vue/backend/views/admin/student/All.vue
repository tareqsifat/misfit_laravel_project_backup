            ...
            <div class="table-responsive card-body text-nowrap">
                <div class="row">
                    <div class="col-6">
                        ...
                        <select name="branch_id" class="form-select mb-3" v-model="branch_id" @change="call_student_by_branch($event)" id="branch_id">
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>{{ item.id }}</td>
                            <td v-if="item.user"><span v-if="item.user.branch_user" class="text-primary">{{ item.user.branch_user[0].name }}</span></td>
