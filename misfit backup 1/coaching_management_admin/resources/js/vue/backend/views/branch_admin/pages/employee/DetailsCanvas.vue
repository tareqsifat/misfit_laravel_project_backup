                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Name</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].first_name }} {{ this[`get_${store_prefix}`].last_name }}</td>
                        </tr>

                        <tr>
                            <td>Email</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].email }}</td>
                        </tr>
                        
                        <tr>
                            <td>Mobile Number</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].mobile_number }}</td>
                        </tr>

                        <tr>
                            <td>Address</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].address }}</td>
                        </tr>
