                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        ...
                        <table v-if="this[`get_${store_prefix}`]" class="table table-bordered details_table">
                            ...
                            <tr v-if="this[`get_${store_prefix}`].customer">
                                <td>Customer</td>
                                <td>{{ this[`get_${store_prefix}`].customer.full_name }} </td>
                            </tr>

                            <tr v-if="this[`get_${store_prefix}`].topic">
                                <td>Topic</td>
                                <td>{{ this[`get_${store_prefix}`].topic.title }} </td>
                            </tr>

                            <tr>
                                <td>Feedback</td>
                                <td>{{ this[`get_${store_prefix}`].feedback }}</td>
                            </tr>
