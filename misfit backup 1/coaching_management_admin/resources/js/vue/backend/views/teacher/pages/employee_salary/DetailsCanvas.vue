                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Name</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].user.first_name }} {{ this[`get_${store_prefix}`].user.last_name }}</td>
                        </tr>

                        <tr>
                            <td>Salary Amount</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].salary_amount }}</td>
                        </tr>

                        <tr>
                            <td>Date</td>
                            <td>:</td>
                            <td v-if="this[`get_${store_prefix}`]">{{ this[`get_${store_prefix}`].date }}</td>
                        </tr>
