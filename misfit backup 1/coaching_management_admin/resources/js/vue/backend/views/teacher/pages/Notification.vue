                            ...
                            <div class="col-lg-12 col-12 p-2">
                                <!-- <div class="demo-inline-spacing"> -->
                                    <div class="list-group">
                                        <span v-for="(item, index) in get_auth_information.user_notification" :key="index">
                                            <a href="javascript:void(0);" :class="getClassName(item)" class="list-group-item list-group-item-action d-flex justify-content-between">
