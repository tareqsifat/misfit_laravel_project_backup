                        ...
                        <div class="row gy-3">
                            <div class="col-md-3 col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="card-info">
                                        <h5 class="mb-0">{{ get_dashboard_stats.total_student }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6 mb-4 mb-xl-0">
                                    ...
                                    <div v-for="(news, index) in get_dashboard_stats.news" :key="index" class="list-group-item list-group-item-action d-flex align-items-center cursor-pointer">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="add-btn">
                                                    <router-link class="btn btn-primary btn-sm waves-effect waves-light" :to="{name:`DetailsTeacherNewsEvent`,params:{id: news.id}}">
                                                        Details
                                                    </router-link>
                                ...
                                <div class="text-center mt-3">
                                    <router-link :to="{name:`AllTeacherNewsEvent`}" class="btn btn-primary btn-sm waves-effect waves-light">View All</router-link>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-6 mb-4 mb-xl-0">
                                        ...
                                        <div class="w-100">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="add-btn">
                                                    ...
                                                    <router-link class="btn btn-primary btn-sm waves-effect waves-light" :to="{name:`DetailsTeacherNotice`,params:{id: news.id}}">
                                                        Details
                                                    </router-link>
                                                </div>
                                            </div>
                                ...
                                <div class="text-center mt-3">
                                    <router-link :to="{name:`AllTeacherNotice`}" class="btn btn-primary btn-sm waves-effect waves-light">View All</router-link>
                                </div>
                            </div>
...
export default {
  ...
  created: function() {
    this.fetch_teacher_dashboard_stats();
    this.fetch_check_auth();
  },
  
  methods: {
    ...mapActions([
        `fetch_teacher_dashboard_stats`,
        `fetch_check_auth`
    ]),
  },
  computed: {
