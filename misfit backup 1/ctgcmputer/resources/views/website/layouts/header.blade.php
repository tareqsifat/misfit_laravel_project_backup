<div id="header_block">
        ...
        <div class="header_area_content container">
            ...
            <div class="item_area">
                ...
                <div class="item account">
                    <span href="#">
                        <div class="icon">
                            <img src="{{ asset('contents/website/images/icons/icon_call.png') }}" alt="chittagong computer call">
                        </div>
                        <div class="title_and_discription">
                            <div class="title">
                                <h2>
                            ...
                            <div class="discription">
                                @php
                                    ...
                                    $setting_first = \App\Models\Setting::select($numbers)->first();
                                @endphp
                                @foreach ($numbers as $number)
                                    <a href="tel:{{ $setting_first->$number }}" class="call_numbers">{{ $setting_first->$number }}</a>
                                @endforeach
                            </div>
                        </div>
                    </span>
    ...
    <div class="responsive_header_bottom">
        <div class="responsive_header_bottom_content">
            ...
            <a href="/wishlist" class="bottom_item gifi">
                <div class="icon">
