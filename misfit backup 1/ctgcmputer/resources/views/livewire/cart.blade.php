                                    ...
                                    @if ($cart)
                                        ...
                                        <tr wire:key="{{ $cart['product']['id'] }}">
                                                ...
                                                <div class="product-details-quality">
                                                    <div class="pro-qty">
                                                        ...
                                                        <input type="text" title="Quantity"
                                                            {{-- wire:keyup.debounce.200ms="quantityChange($event.target.value, {{ $cart['product']['id'] }})" --}}
                                                            wire:change.debounce.200ms="quantityChange($event.target.value, {{ $cart['product']['id'] }})"
                                                            value="{{ $cart['qty'] }}">
                                            ...
                                            <td class="product-total">
                                                @if ($cart['product']->sales_price == "Call for Price" || $cart['product']->sales_price == "Out of Stock")
                                                    <span>
                                                        {{ 0 * $cart['qty'] }}
                                                    </span>
                                                @else
