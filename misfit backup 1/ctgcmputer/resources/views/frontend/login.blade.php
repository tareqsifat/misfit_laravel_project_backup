                                ...
                                <div class="login-register-style">
                                    <form method="POST" wire:submit.prevent="login">
                                        ...
                                        <div class="login-register-input">
                                            ...
                                            <input id="email" type="text" name="email" class="@error('email') is-invalid @enderror" value="{{ old('email') }}" required >
                                        ...
                                        <div class="login-register-input">
                                            ...
                                            <input id="password" type="password" name="password" class="@error('password') is-invalid @enderror" placeholder="Password" >
                                        ...
                                        <div class="form-group row mb-0 mt-2">
                                            <div class="">
                                                <button type="submit"  wire:click.prevent="login" class="btn btn-secondary">
                                                    {{ __('Login') }}
                                                </button>
