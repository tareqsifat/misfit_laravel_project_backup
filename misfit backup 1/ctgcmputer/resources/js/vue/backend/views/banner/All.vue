                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody class="table-border-bottom-0">
                        <tr v-for="item in this[`get_${store_prefix}s`].data" :key="item.id">
                            ...
                            <td>
                                <input @click="call_store(`fetch_${store_prefix}_toggle_status`,item.id)" type="checkbox" v-if="item.show" checked class="form-check-input">
                                <input @click="call_store(`fetch_${store_prefix}_toggle_status`,item.id)" type="checkbox" v-else class="form-check-input">
                            </td>
                            <td>
                                <div class="table_actions">
...
export default {
    ...
    methods: {
        ...mapActions([
            ...
            `fetch_${store_prefix}_toggle_status`,
