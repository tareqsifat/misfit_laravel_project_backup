(function($) {
    ...
    $(document).ready(function() {
        ...
        */
        ...
        ========================================
        */
        $(document).on('mouseenter', '.hoverCustom_tab ul.hoverTab__menu li', function(r) {
            var tab = $(this).closest('.hoverCustom_tab'),
                index = $(this).closest('li').index();
            tab.find('li').siblings('li').removeClass('active');
            $(this).closest('li').addClass('active');
            tab.find('.hoverTab_area').find('div.hoverTab_item').not('div.hoverTab_item:eq(' + index + ')').hide().siblings().removeClass('active');
            tab.find('.hoverTab_area').find('div.hoverTab_item:eq(' + index + ')').show().addClass('active');
            r.preventDefault();
        });
