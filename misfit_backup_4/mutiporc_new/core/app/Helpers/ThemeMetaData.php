...
class ThemeMetaData
{
    ...
    public function getAllThemeData(){
        ...
        foreach ($allDirectories as $dire){
            ...
            if (is_object($themeInformation) && property_exists($themeInformation, 'status') && $themeInformation->status)
            {
    ...
    public function loadCoreStyle()
    {
        ...
        if (is_object($current_theme) && property_exists($current_theme, 'loadCoreStyle'))
        {
    ...
    public function loadCoreScript()
    {
        ...
        if (is_object($current_theme) && property_exists($current_theme, 'loadCoreScript'))
        {
            $load_style = $current_theme->loadCoreScript;
        }
        return $load_style;
    }
}
