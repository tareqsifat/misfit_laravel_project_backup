...
class WeddingPlanController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('pricePlan.allPlan',compact('all_plans','default_lang'));
    }
            ...
            return DataTables::of($donation_logs)
                ...
                ->addColumn('action', function($row){
                    ...
                    $action = '';
                        ...
                        if($row->package_gateway == 'manual_payment' && !empty($row->manual_payment_attachment)){
                            $action .= General::viewAttachment($row);
                        }

                    if($row->package_gateway == 'manual_payment' && $row->payment_status == 'pending'){
