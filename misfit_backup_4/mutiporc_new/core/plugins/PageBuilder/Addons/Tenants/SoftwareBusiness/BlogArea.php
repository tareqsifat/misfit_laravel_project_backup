...
class BlogArea extends PageBuilderBase
{
    ...
    {
        return 'Tenant/SoftwareBusiness/blog-area.png';
    }
    public function admin_render()
    {
        ...
        $output .= Select::get([
            ...
            'placeholder' => __('Select Blog Category'),
            'options' => $categories,
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.software-business.blog-area',$data);
