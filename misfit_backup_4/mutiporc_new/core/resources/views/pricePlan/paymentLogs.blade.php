...
<div class="main-heading-container">
    <div class="common-title">All Wedding Payment Logs</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Wedding Payment Logs</div>
            </div>
            <div class="card-common-body">
                ...
                <div class="card-table-responsive table-wrap table-responsive">
      ...
      $(function () {
            $(document).ready(function () {
                ...
                $('.table-wrap > table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('tenant.admin.wedding.payment.logs') }}",
                    columns: [
