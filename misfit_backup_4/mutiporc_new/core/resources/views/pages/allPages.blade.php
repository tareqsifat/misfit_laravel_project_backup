...
<div class="main-heading-container">
    <div class="common-title">All Pages</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Pages</div>
            </div>
                        ...
                        <tbody>
                            <tr>
                             ...
                             <div class="actions-col">
                                        ...
                                        <a class="actionIcon" href="{{ url('/page-builder') }}">
                                            <span>Duplicate</span>
                                            <i class="fa-solid fa-gear editProfile textOrange"></i>
                                        </a>
