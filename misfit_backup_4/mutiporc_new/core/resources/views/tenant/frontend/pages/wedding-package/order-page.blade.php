                            ...
                            <div class="wedding_package__body mt-4">
                                <ul class="wedding_package__list list-none">
                                    @php
                                        ...
                                        $features_condition = !empty($order_details->features) ? explode("\n",$order_details->features) : explode("\n",$fall_back_features);
                                        $not_available_features_condition = !empty($order_details->not_available_features) ? explode("\n",$order_details->not_available_features) : explode("\n",$fall_back_features);
                                    @endphp
