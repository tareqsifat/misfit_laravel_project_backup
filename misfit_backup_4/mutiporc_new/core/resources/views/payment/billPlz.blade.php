                    ...
                    <div class="row">
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="main-heading-container">
                                ...
                                <div class="common-title mt-2">Manual payment</div>
                            </div>
                                        ...
                                        <div class="card-common-body">
                                            <div class="row">
                                                <div class="form-check form-switch mt-4">
                                                    ...
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">Enable/Disable Manual payment</label>
                                                </div>
                                                <div class="form-check form-switch mt-4">
                                                    <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                                                    <label class="form-check-label" for="flexSwitchCheckDefault">Enable Test Mode Manual payment</label>
                                                </div>
                                                
                                                <div class="col-md-12 mt-4 form-group uploadImgWrapper">
                                                <label>Logo Manual payment</label>
                                                ...
                                                <div class="col-md-12 form-group">
                                                    ...
                                                    <textarea type="text" name="p_c_t_e" value="" class="form-control" placeholder=""></textarea>
                                                   
                                                </div>
                                                <span class="text-primary">It will ask user for transaction id..!</span>
