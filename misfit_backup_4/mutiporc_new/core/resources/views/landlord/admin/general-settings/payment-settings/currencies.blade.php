                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="site_default_payment_gateway" class="form-control">
                                            @php
                                                $all_gateways = ['paypal','manual_payment','mollie','paytm','stripe','razorpay','flutterwave','paystack','midtranse','paystack','marcedopago','instamojo','cashfree','cinetpay','squareup','billplz'];
                                            @endphp
