...
<div class="main-heading-container">
    <div class="common-title">All Paid Applications</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Paid Applications</div>
            </div>
                    ...
                    <table id="customers" class="table tableCommon table-striped table-single-line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <x-delete-popover  permissions="job-category-delete" url="{{route('tenant.admin.job.payment.log.delete', $row->id)}}"/>
