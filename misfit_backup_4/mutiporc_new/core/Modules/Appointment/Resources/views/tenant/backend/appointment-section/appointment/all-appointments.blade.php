...
<div class="main-heading-container">
    <div class="common-title">All Appointment</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Appointment</div>
            </div>
            <div class="card-common-body">
                ...
                <div class="table-wrap table-responsive card-table-responsive">
                   
                            <table class="table table-default tableCommon table-striped table-bordered table-single-line">
                                <thead class="">
                                <th class="no-sort">
