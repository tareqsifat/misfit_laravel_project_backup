...
<div class="main-heading-container">
    <div class="common-title">Add New Event</div>
                ...
                <div class="card-common-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input type="text" name="product_name" value="" class="form-control" placeholder="Venue Location">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <div class="row">
                                <div class="col-md-6 form-group posRel">
                                    <label>Date</label>
                                    <input type="text" class="form-control" id="input_from" name="valid_from" placeholder="Date">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 form-group">
