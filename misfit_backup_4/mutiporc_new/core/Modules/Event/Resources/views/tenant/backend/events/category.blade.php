...
<div class="main-heading-container">
    <div class="common-title">All Events Category</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Events Category</div>
            </div>
            <div class="card-topbar-inner">
                            ...
                            <tr>
                                ...
                                @can('event-category-edit')
                                    <a href="#"
                                       ...
                                       title="{{__('Edit')}}"
                                       data-id="{{$data->id}}"
                                       data-action="{{route('tenant.admin.event.category.update')}}"
                                    ...
                                    @endcan
                                    <x-delete-popover permissions="event-category-delete" url="{{route('tenant.admin.event.category.delete', $data->id)}}"/>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
