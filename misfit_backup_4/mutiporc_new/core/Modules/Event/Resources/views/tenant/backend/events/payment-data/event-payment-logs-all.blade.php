...
<div class="main-heading-container">
    <div class="common-title">All Events Logs</div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card-common">
            <div class="card-topbar-inner">
                <div class="card-topbar-title">All Events Logs</div>
            </div>
                    ...
                    <table id="customers" class="table tableCommon table-striped table-single-line">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <td><a href="{{route('tenant.admin.event.edit/'.$row->id)}}">Edit</a>
                                <a href="{{route('tenant.admin.event.delete/'.$row->id)}}">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
