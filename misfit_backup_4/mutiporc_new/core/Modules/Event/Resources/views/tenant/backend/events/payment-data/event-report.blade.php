...
<div class="main-heading-container">
    <div class="common-title">Event Report</div>
    <a href="{{ url('/admin/product/list') }}" class="btn btn-primary w-170">Back</a>
</div>
<form action="{{route('tenant.admin.event.payment.logs.report')}}" method="get" enctype="multipart/form-data" id="report_generate_form">
    <div class="row mb-4">
        <div class="col-lg-12">
            <div class="card-common">
                <div class="card-topbar-inner">
                    <div class="card-topbar-title">Event Report</div>
                </div>
