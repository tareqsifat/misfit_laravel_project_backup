                        ...
                        <div class="global-flex-card-contents-bottom border-flex-card pt-4 mt-4 pt-lg-5 mt-lg-5">
                            <div class="global-flex-card-contents-icon">
                                ...
                                <div class="icon-list" data-bs-toggle="tooltip" data-bs-placement="top" title="Preview"
                                     ...
                                     data-childCategory="{{json_encode($product->childCategory)}}"
                                     data-sku="{{$product?->inventory?->sku}}"
                                     data-stock="{{$product?->inventory?->stock_count}}"
                                     data-sold_count="{{$product?->inventory?->sold_count}}"
                                     data-sale_price="{{amount_with_currency_symbol($sale_price)}}"
                                     data-regular_price="{{$regular_price != null ? amount_with_currency_symbol($regular_price) : ''}}"
                                     data-color="{{json_encode($product->color)}}"
                                     data-size="{{json_encode($product->size)}}"
