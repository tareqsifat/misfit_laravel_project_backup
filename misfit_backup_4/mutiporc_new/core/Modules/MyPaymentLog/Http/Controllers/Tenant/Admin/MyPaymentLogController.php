<?php
namespace Modules\MyPaymentLog\Http\Controllers\Tenant\Admin;
...
class MyPaymentLogController extends Controller
{
    ...
    public function mypaymentlog()
    {
        return view('mypaymentlog.mypaymentlog');
    }
}
