<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo"><img src="{{getImage(getFilePath('logoIcon') .'/logo.png')}}"></a>
        </div>
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.setting.trading_settings')}}">
                    <a href="{{route('admin.setting.trading_settings')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">Trading Settings</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.setting.ai_trading')}}">
                    <a href="{{route('admin.setting.ai_trading')}}" class="nav-link">
                        <i class="menu-icon las la-life-ring"></i>
                        <span class="menu-title">AI trading</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.setting.chart.setting')}}">
                    <a href="{{route('admin.setting.chart.setting')}}" class="nav-link">
