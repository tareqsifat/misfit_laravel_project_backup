                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <small title="@lang('Comission for trading in this pair.')"><i class="las la-info-circle"></i></small>
                                    <div class="input-group appnend-coin-sym">
                                        <input type="number" step="any" class="form-control" name="commission" value="{{ old('commission',@$coinPair->commission) }}" required >
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
