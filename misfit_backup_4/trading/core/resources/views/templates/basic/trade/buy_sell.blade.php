...
@if (@$meta->screen != 'small')
    <div class="trading-bottom @if (@$meta->screen == 'medium') two @else d-xl-block @endif">
        ...
        <script>
            ...
            (function($) {
                ...
                function changeSellAmountRange(percent) {
                    ...
                    let percentAmount = (availableBalance / 100) * percent; $('.sell-amount').val(getAmount(percentAmount)).trigger(
                        'change');
                }
            ...
            $(this).closest('.trading-bottom').find('.order-wrapper').fadeOut().fadeIn();
