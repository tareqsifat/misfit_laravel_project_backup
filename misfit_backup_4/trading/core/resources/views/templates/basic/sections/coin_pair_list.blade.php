@php
    $meta = (object) $meta;
    $trade_status = \App\Models\AiTrading::select('*')->first();
@endphp
...
@push('script')
    <script>
        ...
        (function($) {
            ...
            @endif
            @if($trade_status->trading == 'inactive')
                trade_status = false;
            @endif
                    ...
                    success: function(resp) {
                        ...
                        $.each(resp.pairs || [], function(i, pair) {
                            ...
                            <tr class="${!loadMore ? 'skeleton' : ''}">
                                ...
                                <td class="text-end">
                                    <a href="${trade_status ? tradeUlr.replace(':symbol','') : '#'}" class="trade_btn btn btn--sm outline">
