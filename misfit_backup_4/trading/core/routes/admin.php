...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('OrderController')->group(function () {
        Route::name('order.')->prefix('order')->group(function () {
            ...
            Route::post('send-comission', 'send_comission')->name('send_comission');
        });
    ...
    Route::controller('GeneralSettingController')->group(function () {
        ...
        Route::get('ai-trading', 'ai_trading')->name('setting.ai_trading');
        Route::post('ai-trading', 'update_ai_status')->name('setting.update_ai');

        Route::get('trading-settings', 'trading_settings')->name('setting.trading_settings');
        Route::post('trading-settings', 'update_trading_settings')->name('setting.update_trading_settings');
        ...
        // trading view chart
        Route::get('chart/setting', 'chartSetting')->name('setting.chart.setting');
        Route::post('chart/setting', 'chartSettingUpdate')->name('setting.chart.setting');
