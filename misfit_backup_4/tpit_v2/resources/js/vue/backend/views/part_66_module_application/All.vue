                ...
                <table class="table table-hover table-bordered">
                    <thead class="table-light">
                        <tr>
                            ...
                            <table-th :sort="true" :tkey="'father_name'" :title="'Father Name'" />
                            <table-th :sort="true" :tkey="'phone_number'" :title="'Phone Number'" />
                            <table-th :sort="true" :tkey="'email'" :title="'Email'" />
                            <table-th :sort="true" :tkey="'gender'" :title="'Gender'" />
                            <table-th :sort="true" :tkey="'nid'" :title="'NID'" />
                            <table-th :sort="true" :tkey="'application_status'" :title="'Status'" />
