<template>
    <div @mouseover="mouseover" @mouseleave="mouseleave">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <left-nav-list-group :role_permissions="['admin']" :icon="`fa fa-users`" :text="`Users`" :alert_count="0">
                <left-nav-list-item :to="'AllUser'" :text="'All users'" />
                <left-nav-list-item :to="'CreateUser'" :text="'Create user'" />
            </left-nav-list-group>

            <left-nav-list-group :role_permissions="['admin']" :icon="`fa fa-list`" :text="`Contact Message`"
                :alert_count="0">
            ...
            <left-nav-list-single :role_permissions="['admin']" :to="{ name: 'AllPart66Module' }" :icon="'fa fa-list'"
                :text="'Part 66 Module'" :alert_count="15" />
