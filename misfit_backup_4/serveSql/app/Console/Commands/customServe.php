...
class customServe extends ServeCommand
{
    ...
    {
        // Call the parent serve command with custom host and port
        parent::handle();

        // Output a custom message with your host and port
        $this->info("Laravel development server started on http://{$this->host}:{$this->port}");
    }
