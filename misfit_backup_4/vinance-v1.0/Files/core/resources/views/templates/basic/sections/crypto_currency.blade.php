...
$cryptoCurrencies = App\Models\Currency::whereHas('marketData')->with('marketData:id,currency_id,html_classes,percent_change_1h,price,last_price')->crypto()->orderByRank()->take(8)->get();
@endphp

<sectio  class="currency-section py-120 section-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
