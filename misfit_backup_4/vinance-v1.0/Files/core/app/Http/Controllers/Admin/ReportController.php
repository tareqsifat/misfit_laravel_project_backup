...
class ReportController extends Controller
{
    public function transaction(Request $request)
    {
        ...
        $transactions = Transaction::with('wallet.currency')->searchable(['trx','user:username'])->filter(['trx_type','remark'])->dateFilter()->orderBy('id','desc')->with('user')->paginate(getPaginate());
