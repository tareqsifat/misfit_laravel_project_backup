...
@section('content')
                    ...
                    <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                        <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                            ...
                            <div class="table-responsive zTable-responsive">
                                <table class="table zTable" id="howItsWorkDataTable">
                                    <thead>
                                        <tr>
                                            <th>
                                                <div>{{ __('Image') }}</div>
    ...
    <input type="hidden" id="how-its-work" value="{{ route('saas.super_admin.frontend-setting.how-its-works.index') }}">
@endsection
@push('script')
    <script src="{{ asset('super_admin/custom-js/how-its-work.js') }}"></script>
@endpush
