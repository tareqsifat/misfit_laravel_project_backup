...
@section('content')
    ...
    <div class="modal fade" id="add-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="ajax reset" action="{{ route('saas.super_admin.frontend-setting.features.store') }}" method="post"
    ...
    <input type="hidden" id="features_setting" value="{{ route('saas.super_admin.frontend-setting.features.index') }}">
@endsection
@push('script')
    <script src="{{ asset('super_admin/custom-js/features_setting.js') }}"></script>
@endpush
