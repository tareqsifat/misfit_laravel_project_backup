            ...
            <tfoot>
                ...
                {{-- @if(isset($order->total_vat))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->total_vat }}</span></td>
                    </tr>
                @endif --}}
                ...
                @if(isset($order->shipping_charge))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->shipping_charge }}</span></td>
                    </tr>
                @endif
                ...
                @if(isset($order->card_price))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->card_price }}</span></td>
                    </tr>
                @endif
                ...
                @if(isset($order->packaging_price))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->packaging_price }}</span></td>
                    </tr>
                @endif
                ...
                @if(isset($order->discount_amount))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->discount_amount }}</span></td>
                    </tr>
                @endif
                ...
                @if(isset($order->net_receiveable_amount))
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $order->net_receiveable_amount }}</span></td>
                    </tr>
                @endif
            </tfoot>
        </table>
