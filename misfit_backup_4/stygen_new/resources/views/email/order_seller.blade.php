            ...
            <tbody>
                ...
                @foreach($orderdetails as $key => $order_detail)
                    ...
                    @php
                        ...
                        $productInfo = App\Models\Product::where('id', $order_detail->product_id)->select('regular_price', 'sales_price')->first();
                        if(isset($productInfo)){
                            if($productInfo->sales_price > 0 && $productInfo->sales_price != NULL){
                                $discount += ($productInfo->regular_price) - ($productInfo->sales_price);
                            }
                        }
                    @endphp
                @endforeach
            ...
            <tfoot>
                ...
                @if($discount > 0)
                    <tr>
                        ...
                        <td><span><span>৳&nbsp;</span>{{ $subTotal - $discount }}</span></td>
                    </tr>
                @else
                    <tr>
                        <th scope="row" colspan="4">Net Total Amount:</th>
