		                        ...
		                        <div class="communication-info">
		                            ...
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>House: 65, Level-2, Road: 03, Block: B, Niketon, Gulshan-1, Dhaka <br>Bangladesh</span>
		                                </div>
		                            </div>
		                            ...
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>Call us: <br><a href="tel:+8801971971520">(88) 01971 971 520</a></span>
		                                </div>
		                            </div>
		                            <!--Single Communication End-->
                                    <!--Single Communication Start-->
		                            <div class="single-communication">
		                                ...
		                                <div class="communication-text">
		                                    <span>Email us: <br><a href="mailto:contact@stygen.gift">contact@stygen.gift</a></span>
		                                </div>
		                            </div>
		                            <!--Single Communication End-->
		                        </div>
