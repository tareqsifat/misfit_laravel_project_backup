<template>
    <div id="product_duplicate">
        <div v-if="checkoutLoader" class="loader-css"></div>
        <div class="content-wrapper product-duplicate-area">
            <!-- Main content -->
            <div class="content">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header border-0">
                                    <h3 class="card-title text-bold">Product Duplicate</h3>
                                </div>

                                <div class="card-body pt-0">
                                    <el-form ref="form" @submit.prevent="duplicateProduct()">
                                        <el-row :gutter="20">
                                        ...
                                        <el-form-item class="text-right mt-4">
                                            ...
                                            <el-button type="primary" @click.prevent="duplicateProduct()">Create</el-button>
                                        </el-form-item>
                                    </el-form>
    ...
    export default {
        ...
        methods: {
            ...
            duplicateProduct(){
                ...
                $('.product-duplicate-area').css('filter','blur(2px)');
                ...
                axios.post(`/seller/product-duplicate/${this.$route.params.id}`, formData)
                    .then((result) => {
                        this.checkoutLoader = false
                        $('.product-duplicate-area').css('filter','none');
        ...
        computed:{
            ...
            product(){
                return this.$store.getters['product/editProduct'];
            },
            shippings(){
