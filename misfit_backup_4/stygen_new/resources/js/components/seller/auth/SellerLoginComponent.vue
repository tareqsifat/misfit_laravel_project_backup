        ...
        <div class="login-box ml-auto mr-auto">
            ...
            <div class="card">
                <div class="card-body login-card-body">
                    <h3 class="text-center text-uppercase">Seller Login</h3>
                    ...
                    <p class="mb-1">
                        <router-link :to="{name: 'sellerForgotPassword'}">I forgot my password</router-link>
                    </p>
                    <p class="mb-0">
                        <router-link :to="{name: 'sellerRegister'}" class="text-center">Register as a new seller?</router-link>
                    </p>
                </div>
                <!-- /.login-card-body -->
            </div>
...
<script>
    export default {
        ...
        methods:{
            adminLogin(){
                axios.post('/seller/login', this.form)
                .then((result) => {
