...
@section('content')
    ...
    <div class="intro-y box mt-5">
        ...
        <form method="POST" class="insert_form" action="{{ route('user_update',$collection->id) }}" enctype="multipart/form-data" id="horizontal-form">
            @csrf
            @method('PUT')
            <div class="preview">
                <div class="form-group p-4">
                    ...
                    <img src="{{ '/uploads/users' }}/{{ $collection->photo }}" width="50px" alt="">
                </div>
                {{-- <div class="preview"> --}}
                <div class="form-group p-4">
                    ...
                    @error('firstname')
                        <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="firstname" type="text" class="form-control" value="{{ $collection->firstname }}">
                </div>
                <div class="form-group p-4">
                    ...
                    @error('lastname')
                        <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="lastname" type="text" class="form-control" value="{{ $collection->lastname }}">
                </div>
                <div class="form-group p-4">
                    ...
                    @error('username')
                        <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="username" type="text" class="form-control" value="{{ $collection->username }}">
                </div>
                    {{-- <div class="preview"> --}}
                <div class="form-group p-4">
                    ...
                    @error('email')
                        <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="email" type="email" class="form-control" value="{{ $collection->email }}" >
                </div>
                <div class="form-group p-4">
                ...
                <div class="form-group p-4">
                    ...
                    <div class="text-theme-6 mt-2">{{ $message }}<br></div>
                    @enderror
                    <input id="horizontal-form-1" name="password_confirmation" type="password" class="form-control" >
                </div>
